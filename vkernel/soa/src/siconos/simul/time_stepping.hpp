...
struct time_stepping : item<> {
  ...
  using time_discretization_t = ground::nth_t<0, items>;
  using one_step_integrator_t = ground::nth_t<1, items>;
  using one_step_nonsmooth_problem_t = ground::nth_t<2, items>;
  using topology_t = ground::nth_t<3, items>;
