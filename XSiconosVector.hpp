...
#ifndef __XSiconosVector__
#define __XSiconosVector__
...
DEFINE_SPTR(XSiconosVector)

struct SiconosVectorIterator;
struct SiconosVectorConstIterator;

using XDenseVect = ublas::vector<double, std::vector<double, boost::pool_allocator<double> >>;

/** Union to gather all types of ublas vectors used in Siconos */
union XVECTOR_UBLAS_TYPE
{
  XDenseVect *Dense; // num = 1
...
*/
class XSiconosVector : public std::enable_shared_from_this<XSiconosVector>
{
protected:
  ACCEPT_SERIALIZATION(XSiconosVector);
...
public:
   ...
   */
  XSiconosVector(unsigned row, Siconos::UBLAS_TYPE type = Siconos::DENSE);
   ...
   */
  XSiconosVector(unsigned row, double val, Siconos::UBLAS_TYPE type = Siconos::DENSE);
   ...
   */
  XSiconosVector(const std::vector<double>& vec, Siconos::UBLAS_TYPE type = Siconos::DENSE);

  /** copy constructor
   *
   *  \param v source vector to be copied
   */
  XSiconosVector(const XSiconosVector& v);

  /** creates a dense vector, with a copy.
   *
   *  \param v source vector (ublas dense)
   */
  XSiconosVector(const XDenseVect& v);

  /** creates a sparse vector, with a copy.
   *
   *  \param v source vector (ublas sparse)
   */
  XSiconosVector(const SparseVect& v);
   ...
   */
  XSiconosVector(const std::string& filename, bool is_ascii);
   ...
   */
  XSiconosVector(const XSiconosVector& v1, const XSiconosVector& v2);
   ...
   */
  explicit XSiconosVector(const BlockVector& input);//, bool = false);
  ...
  /** cast a XSiconosVector into a std::vector<double> (performs copy) */
  ...
  */
  void setBlock(unsigned int i, const XSiconosVector& v);
  ...
  */
  void toBlock(XSiconosVector& vOut, unsigned int sizeB,
   ...
   */
  void addBlock(unsigned int i, const XSiconosVector& v);
  ...
  /** 
      ...
      \param v the source vector to be added
   */
  void subBlock(unsigned int i, const XSiconosVector& v);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator = (const XSiconosVector& v);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator = (const BlockVector& b);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator = (const XDenseVect& v);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator = (const SparseVect& sp);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator = (const double* d);
   ...
   *  \return  XSiconosVector&
   */
  XSiconosVector& operator +=(const BlockVector& v);
  ...
  /** \defgroup XSiconosVectorFriends

      List of friend functions of the XSiconosVector class
  ...
  */
   ...
   *  \param sv a XSiconosVector
   *  \return The same output stream
   */
  friend std::ostream& operator<<(std::ostream& os, const XSiconosVector& sv);

  friend XSiconosVector& operator *= (XSiconosVector& v, const double& s);

  friend XSiconosVector& operator /= (XSiconosVector& v, const double& s);

  friend bool operator ==(const XSiconosVector&, const XSiconosVector&);

  friend XSiconosVector operator * (double, const XSiconosVector&);

  friend XSiconosVector operator * (const XSiconosVector&, double);

  friend XSiconosVector operator / (const XSiconosVector&, double);

  friend XSiconosVector operator + (const XSiconosVector&, const XSiconosVector&);

  friend void add(const XSiconosVector&, const XSiconosVector&, XSiconosVector&);

  friend XSiconosVector operator - (const XSiconosVector&, const XSiconosVector&);

  friend void sub(const XSiconosVector&, const XSiconosVector&, XSiconosVector&);

  friend void axpby(double, const XSiconosVector&, double, XSiconosVector&);

  friend void axpy(double, const XSiconosVector&, XSiconosVector&);

  friend double inner_prod(const XSiconosVector&, const XSiconosVector&);

  friend SimpleMatrix outer_prod(const XSiconosVector&, const XSiconosVector&);

  friend void scal(double, const XSiconosVector&, XSiconosVector&, bool);

  friend void subscal(double, const XSiconosVector&, XSiconosVector&, const Index&, bool);

  friend void cross_product(const XSiconosVector&, const XSiconosVector&, XSiconosVector&);

  friend void abs_wise(const XSiconosVector&, XSiconosVector&);

  friend void getMax(const XSiconosVector&, double &, unsigned int &);

  friend void  getMin(const XSiconosVector&, double &, unsigned int &);
...
struct IsDense : public Question<bool>
{
  ...
  void visit(const XSiconosVector& v)
  {
    answer = v._dense;
  }
