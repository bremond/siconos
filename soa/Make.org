...
#+header: :var data_filename2=(concat "build-clang-release" "/src/siconos/benchmarks/ColumnOfBeadsTS.csv") 
...
[[file:./.ob-jupyter/fbc8b6860ffa6553016a0e85bdee4949646d2517.png]]
:END:
...
:RESULTS:
: Text(0.5, 0, 'number of beads')
[[file:./.ob-jupyter/e378e0716e655acfff901028fc066364b8a96b4c.png]]
:END:

#+RESULTS: ctrl-plot-pena-2
:RESULTS:
: Text(0.5, 0, 'number of beads')
[[file:./.ob-jupyter/0ad1fe875c3dad8b2ae26340b6e0f118cc341a9c.png]]
:END:
...
#+RESULTS: startup
: ((jupyter-sage . python) (jupyter-julia . julia) (jupyter-python3 . python) (jupyter-python . python) (jupyter-bash . bash) (inline-js . javascript) (C . c) (C++ . c++) (asymptote . asy) (beamer . latex) (calc . fundamental) (cpp . c++) (ditaa . artist) (desktop . conf-desktop) (dot . fundamental) (elisp . emacs-lisp) (ocaml . tuareg) (screen . shell-script) (sqlite . sql) (toml . conf-toml) (shell . sh) (ash . sh) (sh . sh) (bash . sh) (jsh . sh) (bash2 . sh) (dash . sh) (dtksh . sh) (ksh . sh) (es . sh) (rc . sh) (itcsh . sh) (tcsh . sh) (jcsh . sh) (csh . sh) (ksh88 . sh) (oash . sh) (pdksh . sh) (mksh . sh) (posix . sh) (wksh . sh) (wsh . sh) (zsh . sh) (rpm . sh))
