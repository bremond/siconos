...
#+name: mybenchmarks-make-clang-debug-siconos-vview
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrun src/siconos/tests/disks.py --vview ./disks.hdf5
#+end_src
...
#+begin_src sh :compile :results none
  rsync -avt . --exclude=build-* --exclude=venv massiveattack:/scratch/bremond/disks/local-src
#+end_src
...
#+name: massiveattack-run
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks.py 
#+end_src
