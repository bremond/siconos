...
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs --share=${src_dir} \
       -m ../siconos-disks-manifest.scm -- \
       dash -c "cmake ${src_dir} -DSICONOS_INSTALL_DIR=\${GUIX_ENVIRONMENT} -DCMAKE_BUILD_TYPE=Release -DCMAKE_EXPORT_COMPILE_COMMANDS=1" 
#+end_src
...
#+name: mybenchmarks-build-h5hut-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --pure --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir} \
       -m ../h5hut.scm -m ../siconos-disks-manifest.scm -- \
       dash -c "echo ok"
#+end_src
...
#+name: mybenchmarks-make-help-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
...
#+name: mybenchmarks-make-to-h5part-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --pure --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir} \
       -m ../h5hut.scm -m ../siconos-disks-manifest.scm -- \
       dash -c "make to-h5part"
#+end_src


#+name: mybenchmarks-try-to-h5part-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos/src/siconos/utils/to-h5part
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --pure --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir} \
       -m ${src_dir}/h5hut.scm -m ${src_dir}/siconos-disks-manifest.scm -- \
       dash -c "./to-h5part"
#+end_src
...
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir} \
       -m ../h5hut.scm -m ../.siconos-disks-manifest.scm -- \
       make -j1 _nonos
#+end_src


#+name: mybenchmarks-bouncing-disk-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --pure --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir}  \
       -m ${src_dir}/h5hut.scm -m ${src_dir}/siconos-disks-manifest.scm -- \
       make VERBOSE=1 -j1 bouncing_disk && { cd ./src/siconos/tests; LLVM_PROFILE_FILE=bouncing_disk.profraw ./bouncing_disk ;}
#+end_src
...
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       ...
       make -j1 bouncing_disk_sf && { cd ./src/siconos/tests; ./bouncing_disk_sf ;}
#+end_src



#+name: mybenchmarks-bouncing-disk-line-clang-debug-siconos
#+header: :var src_dir=src-dir
#+header: :dir build-clang-debug-siconos
#+begin_src sh :compile :results output silent
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --pure --expose=/scratch/maurice/install/maurice/siconos/mymaster/ --share=${src_dir} fclib  strace benchmark clang-toolchain suitesparse eigen boost fmt range-v3 cmake make dash python pybind11 -- \
       make -j1 bouncing_disk_line && { cd ./src/siconos/tests; ./bouncing_disk_line ;}
#+end_src
...
#+begin_src sh :compile :results output silent
    ...
    /scratch/maurice/install/maurice/siconos/mymaster/Debug/siconos/bin/siconos ${src_dir}/src/siconos/tests/disks.py
    cp disks.hdf5 ../disks-o.hdf5"
#+end_src

#+name: try-particles
#+begin_src sh :compile :results output silent
  ./vrun --script src/siconos/py/nonos/particles.py
#+end_src

#+name: bench-vrun-diskss.py
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./bench > bench.log
#+end_src
...
#+name: perf-vrun-disks.py
#+header: :dir .
#+begin_src sh :compile :results output silent
  guix shell perf -- perf record -g --call-graph dwarf ./vrun --fast src/siconos/tests/diskss.py 50 > diskss.log
#+end_src


#+name: vrun-vview-bouncing-disk
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrun --fast --vview --no-cf bouncing_disk.hdf5
#+end_src


#+name: vrunn-bouncing-disk.py
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrun --fast src/siconos/tests/bouncing_disk.py bullet > bouncing_disk.logy
#+end_src
...
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrun --fast src/siconos/benchmarks/bench.sh 2 1 2
#+end_src

#+name: vrunn-vview-disks
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrun --fast --vview diskss.hdf5 
#+end_src

#+name: vrunn-vvexport-disks
#+header: :dir .
#+begin_src sh :compile :results output silent
  ./vrunn -x --vexport-para --nprocs 10 diskss.hdf5
#+end_src
...
#+name: vrun-install
#+header: :dir .
#+begin_src sh :compile :results none
  ./vrun --install
#+end_src



#+name: massiveattack-rsync
#+begin_src sh :compile :results none
  rsync -avt . --exclude=build-* --exclude=venv --exclude *.hdf5 massiveattack:/scratch/bremond/disks/local-src
#+end_src

#+name: massiveattack-install
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  ./vrun --install
#+end_src


#+name: massiveattack-run-10
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks-10.py > disks-10.txt 
#+end_src

#+name: massiveattack-run-10-vview
#+header: :dir .
#+begin_src sh :compile :results none
  rsync massiveattack:/scratch/bremond/disks/local-src/disks-10.hdf5 disks-10.hdf5
  ./vrun --vview disks-10.hdf5
#+end_src

#+name: massiveattack-run-50-vview
#+header: :dir .
#+begin_src sh :compile :results none
  rsync massiveattack:/scratch/bremond/disks/local-src/disks-50.hdf5 disks-50.hdf5
  ./vrun --vview disks-50.hdf5
#+end_src

#+name: massiveattack-run-50
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks-50.py > disks-50.txt
#+end_src

#+name: massiveattack-run-100
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks-100.py > disks-100.txt 
#+end_src

#+name: massiveattack-run-500
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks-500.py > disks-500.txt 
#+end_src

#+name: massiveattack-run-1000
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src
#+begin_src sh :compile :results none
  nohup ./vrun src/siconos/tests/disks-1000.py > disks-1000.txt 
#+end_src



#+name: massiveattack-run-100-vview
#+header: :dir .
#+begin_src sh :compile :results none
  rsync massiveattack:/scratch/bremond/disks/local-src/disks-100.hdf5 disks-100.hdf5
  ./vrun --vview disks-100.hdf5
#+end_src

#+name: massiveattack-run-500-vview
#+header: :dir .
#+begin_src sh :compile :results none
  rsync massiveattack:/scratch/bremond/disks/local-src/disks-500.hdf5 disks-500.hdf5
  ./vrun --vview disks-500.hdf5
#+end_src


#+name: massiveattack-run-10-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-10.py > disks-10.txt
#+end_src

#+name: massiveattack-run-10-ref-vview
#+header: :dir .
#+begin_src sh :compile :results none
  rsync massiveattack:/scratch/bremond/disks/local-src/ref/disks-10.hdf5 ref-disks-10.hdf5
  ./vrun --vview ref-disks-10.hdf5
#+end_src


#+name: massiveattack-run-50-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-50.py > disks-50.txt
#+end_src

#+name: massiveattack-run-100-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-100.py > disks-100.txt
#+end_src

#+name: massiveattack-run-10-bullet-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-bullet-10.py > disks-bullet-10.txt
#+end_src


#+name: run-10-bullet-ref
#+header: :var src_dir=src-dir
#+header: :dir ref
#+begin_src sh :compile :results none
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=/tmp --share=${src_dir} siconos coreutils time -- \
  time -f '%E %M' siconos ../src/siconos/tests/disks-bullet-10.py > disks-bullet-10.txt
#+end_src

#+name: run-bulletc-ref
#+header: :var src_dir=src-dir
#+header: :dir ref
#+begin_src sh :compile :results none
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=/tmp --share=${src_dir} siconos coreutils time -- \
  time -f '%E %M' siconos ../src/siconos/tests/disks-bullet-c.py > disks-bullet-c.txt
#+end_src
...
#+header: :dir .
#+begin_src sh :compile :results none
  ./vrun src/siconos/tests/disks-c.py --vview disks-c.hdf5
#+end_src



#+name: run-50-bullet-ref
#+header: :var src_dir=src-dir
#+header: :dir ref
#+begin_src sh :compile :results none
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-bullet-50.py > disks-bullet-50.txt
#+end_src

#+name: run-100-bullet-ref
#+header: :var src_dir=src-dir
#+header: :dir ref
#+begin_src sh :compile :results none
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
       shell --container -N --emulate-fhs  --share=${src_dir} siconos coreutils time -- \
  nohup time -f '%E %M' siconos ../src/siconos/tests/disks-bullet-100.py > disks-bullet-100.txt
#+end_src
...
#+name: run-10-bullet-ref-vview
#+begin_src sh :compile :results none
 ./vrun --vview ref/disks-bullet-10.hdf5
#+end_src

#+name: run-50-bullet-ref-vview
#+begin_src sh :compile :results none
 ./vrun --vview ref/disks-bullet-50.hdf5
#+end_src

#+name: run-100-bullet-ref-vview
#+begin_src sh :compile :results none
 ./vrun --vview ref/disks-bullet-100.hdf5
#+end_src
...
#+name: run-c-vview
#+begin_src sh :compile :results none
 ./vrun --vview ref/disks-bullet-c.hdf5
#+end_src
...
#+name: massiveattack-run-50-bullet-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
...
#+name: massiveattack-run-100-bullet-ref
#+header: :dir /rsync:massiveattack:/scratch/bremond/disks/local-src/ref
#+begin_src sh :compile :results none
  src_dir=/scratch/bremond/disks/local-src
  guix time-machine -C ${src_dir}/siconos-2023-11-08.scm -- \
...
#+header: :dir .
#+begin_src sh :compile :results none
  ./vrunn --vview occ_slider_crank.hdf5
#+end_src
